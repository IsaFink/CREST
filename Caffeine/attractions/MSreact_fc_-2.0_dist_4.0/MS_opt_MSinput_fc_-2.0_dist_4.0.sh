...
#BSUB -q hpc
### -- set the job Name -- 
#BSUB -J MS_opt_MSinput_fc_-2.0_dist_4.0
...
/zhome/92/7/155378/miniforge3/envs/crest_env/bin/crest /work3/ishof/SK/CREST/Caffeine/CaffeineH.xyz -msinput MSinput_fc_-2.0_dist_4.0 -msreact --msmolbar --mslargeprint --T 16 --chrg 1
